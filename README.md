...
This repository shows all the steps of how I cracked the password of a PDF file using NW tools.
...
- **Web Browser**
- **My Locked PDF1.pdf**
- **Notepad** for saving the extracted hash
...
![Selected John.exe](./screenshots/1-Selected-John-exe.png)

---

## Step 2 — Extract the PDF Hash

The encrypted PDF file was processed to obtain its password hash. The extracted value is represented in the `$pdf$...` format, which can be used by John the Ripper for password recovery.

The complete hash was copied and prepared for use with the cracking tool.

### Screenshot

![PDF Hash Extracted](./screenshots/2-Figured-Out-the-hashCrack.png)
...
![Password Recovered Using JTR](./screenshots/3-Gotten-the-passwod-JTR.png)
...
![PDF Opened Successfully](./screenshots/4-Opened-Sucessfully.png)
...
![PDF Uploaded to Hash Calculator](./screenshots/5-uploaded-pdf-on-calculator.png)
...
![Hash Pasted into Calculator](./screenshots/6-pasted-the-hash-oncalc.png)
...
![Password Recovered Using Networkwalks](./screenshots/7-Gotten-the-pass-from-calc.png)
...
The complete workflow followed during this project can be summarized as:
...
```text
   ...
   John the Ripper             Networkwalks
      + Johnny                Hash Calculator
          │                         │
          ▼                         ▼
    Password Attack          $pdf$ Hash Generated
          │                         │
          ▼                         ▼
   Password Recovered       Password Cracker
          │                         │
          └────────────┬────────────┘
                       ▼
                Password Found
